...
namespace RecommenderAttacksAnalytics.Utililty
{
    public class DatabaseInfos : DependencyObject
    {
        ...
        private const string DEFAULT_SCHEMA = "useritemratings";
        ...
        public string FakeProfilesSchema
        {
            get { return (string)GetValue(FakeProfilesSchemaProperty); }
            set { SetValue(FakeProfilesSchemaProperty, value); }
        }

        public static readonly DependencyProperty FakeProfilesSchemaProperty =
            DependencyProperty.Register("FakeProfilesSchema", typeof(string), typeof(DatabaseInfos), new UIPropertyMetadata(""));
        ...
        public DatabaseInfos()
            :this(DEFAULT_USERNAME, DEFAULT_PASSWORD, DEFAULT_HOSTNAME, DEFAULT_PORT, DEFAULT_SCHEMA)
        {
            
        }

        public DatabaseInfos(string username, string password, string hostname, int port, string schema)
        {
            Username = username;
            Password = password;
            HostName = hostname;
