...
namespace RecommenderAttacksAnalytics.UI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// Replaces the content of the central placeholder by a particular page
        /// </summary>
        /// <param name="pageToLoad">The page to display</param>
        /// <param name="parameters">The change parameters</param>
        ...
        /// <summary>
        /// Returns a page based on its enum representation
        /// </summary>
        /// <param name="pageAsEnum">An enum representing a page</param>
